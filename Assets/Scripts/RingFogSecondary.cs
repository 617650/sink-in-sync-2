...
public class RingFogSecondary : MonoBehaviour
{
    ...
    private Color AlertColor = new Color32(225, 28, 0, 40);
     ...
     public ParticleSystem.MainModule ringFogSecondary;
    // Start is called before the first frame update
    void Start()
    {
        ringFogSecondary = GetComponent<ParticleSystem>().main;

        ringFogSecondary.startColor = SleepyColor; 
    }
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown (KeyCode.Space)){
            ringFogSecondary.startColor = RelaxedColor; 
        }
    }
}
